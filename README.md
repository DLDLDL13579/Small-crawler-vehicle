...
packet-beta
  0-7: "帧头 0x7B"
  8-15: "Flag_Stop 软件失能标志"
  16-63: "X / Y / Z 速度 (int16 大端 ×3)"
  64-111: "加速度计 X/Y/Z (int16 大端 ×3)"
  112-159: "陀螺仪 X/Y/Z (int16 大端 ×3)"
  160-175: "电源电压 (int16 大端)"
  176-223: "Roll / Pitch / Yaw (×100)"
  224-271: "里程计 X / Y / Theta (×100)"
  272-279: "校验 = 前34字节异或"
  280-287: "帧尾 0x7D"
```
